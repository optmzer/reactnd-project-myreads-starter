...
class HomePage extends Component  {
  ...
  componentWillReceiveProps() {
    // console.log('HomePage this.props.books = ', this.props.books)
  }

  render() {

    // console.log('aBook', this.props.books[0])
                ...
                <ol className="books-grid">
                  ...
                  <li>
                    <div className="book">
                      ...
                      <div className="book-title">Ender_s Game</div>
                ...
                <ol className="books-grid">
                  ...
                  <li>
                    <div className="book">
                      ...
                      <div className="book-title">Harry Potter and the Sorcerer_s Stone</div>
